...
#         for i in range(1, 5):
#             for x in range(i):
#                 a = Account(**{"deposit": i * 10 + x})
#                 a.save()
#                 a.customer.set([customer_list[i-1]])
#
#
#
...
#
#         c1 = Customer(name="Arisha Barron")
#         c2 = Customer(name="Branden Gibson")
#         c3 = Customer(name="Rhonda Church")
#         c4 = Customer(name="Georgina Hazel")
#
#         customer_list = [c1, c2, c3, c4]
...
#
#         self.accounts = [
#             {"id": 1, "deposit": 100, "customer": c1},
#             {"id": 2, "deposit": 10, "customer": c2},
#             {"id": 3, "deposit": 150, "customer": c3},
#             {"id": 4, "deposit": 15, "customer": c4}
#         ]
#
#         for a in self.accounts:
#             self.factory.post('/api/accounts', a)
#
#     def test_users(self):
#         """
